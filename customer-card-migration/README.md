...
| 파일 | 목적 | 이식 대상 |
|---|---|---|
| `companies-integrated.json` | 354개사 통합 원본 데이터 | ✅ 데이터 |
...
| `companies-list.html` | **전체 354개사 표 목록** (검색·필터·정렬·상세 펼치기·CSV·**원본 동기화**) | ❌ 확인·공유용 |
| `customer-card-preview.html` | 상태별 카드 8종 + 전체 354개사 카드 시안 | ❌ 확인용 |
...
- `companies-list.html` — **354개사 전체를 표로** 봅니다. 데이터가 파일 안에 들어 있어
...
기존 협력업체 275 · 신규 MOU 프로세스 유입 159 · 등급 보유 257 · 레거시 엑셀 협약 명부 등재 257
