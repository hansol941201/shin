...
`demo.html` 을 브라우저로 열면 전체 기능을 바로 확인할 수 있습니다.
...
| `demo.html` · `demo.js` | 동작 확인용 화면 |
| `test/` | 로직 116건 + 브라우저 85건 검증 (첨부 엑셀 원본 포함) |
...
| `test/browser.test.js` | 실제 브라우저(Chromium) 화면 동작·레이아웃 | 85건 통과 |
