...
(async()=>{
  ...
  if(process.env.RATE) await page.addInitScript(r=>{window.__RATE__=r;}, +process.env.RATE);
  if(process.env.PHLABEL) await page.addInitScript(()=>{window.__PHLABEL__=true;});
