 ...
 *
 * 배포 전 준비:
 *   firebase functions:config:set hiworks.user="your_id@company.com" hiworks.pass="비밀번호_또는_전용_애플리케이션_비밀번호"
...
// 하이웍스 SMTP 설정 (일반적인 값 — 회사 하이웍스 관리자 페이지에서 정확한 host/port 확인 필요)
//   host: smtp.hiworks.com, port 465(SSL) 또는 587(STARTTLS)
