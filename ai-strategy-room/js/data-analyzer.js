...
const DataAnalyzer = {
  ...
  buildMeasurementPlan(topicHint) {
    return {
      baseline: '현재 기준값을 먼저 확정한다 (예: 최근 1~3개월 전화/카카오톡 문의 건수, 플랫폼 방문·가입·이용 건수).',
      collect: '무엇을 수집할지 정의한다 (현장등록 수, 노출 수, 클릭 수, 신청 수, 실제 이용 수, 재이용 수 등 단계별 카운트).',
      source: '어디서 수집할지 정의한다 (플랫폼 로그, 콜센터/카카오톡 상담 기록, CRM 등).',
